import * as THREE from "npm:three@0.160.0/build/three.module.js";
import Stats from "npm:three@0.160.0/examples/jsm/libs/stats.module.js";
import { GUI } from "npm:three@0.160.0/examples/jsm/libs/lil-gui.module.min.js";
import { OrbitControls } from "npm:three@0.160.0/examples/jsm/controls/OrbitControls.js";
import { MarchingCubes } from "npm:three@0.160.0/examples/jsm/objects/MarchingCubes.js";
import {
  ToonShader1,
  ToonShader2,
  ToonShaderDotted,
  ToonShaderHatching,
} from "npm:three@0.160.0/examples/jsm/shaders/ToonShader.js";
...
function setupGui() {
  ...
  for (const m in materials) {
    effectController[m as keyof typeof effectController] = createHandler(
      m,
    ) as never;
