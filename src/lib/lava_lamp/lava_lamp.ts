...
function generateMaterials() {
  ...
  const toonMaterial1 = createShaderMaterial(ToonShader1 as unknown as THREE.ShaderMaterial, light, ambientLight);
  const toonMaterial2 = createShaderMaterial(ToonShader2 as unknown  as THREE.ShaderMaterial, light, ambientLight);
